...
public abstract class OptimizerRunner implements Runnable {
    ...
    protected OptimizerRunner(OptimizerDialog optimizerDialog, Strategy strategy, StrategyParams params) throws JArbitragerException {
        ...
        try {
            ...
            throw new JArbitragerException("Could not find class " + strategy.getClass().getName());
        }
        ...
        try {
            ...
            throw new JArbitragerException("Could not find strategy constructor for " + strategy.getClass().getName());
        }
    ...
    public Strategy getStrategyInstance(StrategyParams params) throws JArbitragerException {
        try {
            return (Strategy) strategyConstructor.newInstance(params);
        } catch (InvocationTargetException ite) {
            throw new JArbitragerException(ite.getCause());
        } catch (Exception e) {
            throw new JArbitragerException(e);
        }
    }


    protected abstract void optimize() throws JArbitragerException;
    ...
    void execute(Queue<StrategyParams> tasks) throws JArbitragerException {
        if (!tasks.isEmpty()) {
    ...
    private void saveToFile() throws JArbitragerException {
    ...
    public void run() {
        try {
            ...
            backTestFileReader.scan(instruments);
