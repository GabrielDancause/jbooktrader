...
public class AdvancedOptimizationOptionsDialog extends JDialog {
    ...
    private void genericAdd(JPanel panel, JArbitragerPreferences pref, Component comp, Dimension dimension) {
    ...
    private void add(JPanel panel, JArbitragerPreferences pref, JSlider slider) {
