 ...
 *
 */
public class ES_NQ extends Strategy {
    ...
    public ES_NQ(StrategyParams optimizationParams) throws JArbitragerException {
        ...
        Contract contract2 = ContractFactory.makeFutureContract("NQ", "GLOBEX");
        Commission commission2 = CommissionFactory.getBundledNorthAmericaFutureCommission();
        Instrument instrument2 = new Instrument(contract2, commission2, 20);
    ...
    public void setParams() {
        addParam(PERIOD, 5, 1200, 5, 900);
        addParam(ENTRY, 3, 20, 1, 14);
    }
    ...
    public void evaluate() {
        ...
        if (emaDifferential <= -entry) {
            instrument1.setTargetPosition(2);
            instrument2.setTargetPosition(-3);
