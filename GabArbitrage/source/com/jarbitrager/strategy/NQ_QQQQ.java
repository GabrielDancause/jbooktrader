 ...
 *
 */
public class NQ_QQQQ extends Strategy {
    ...
    public NQ_QQQQ(StrategyParams optimizationParams) throws JArbitragerException {
        super(optimizationParams);


        Contract contract1 = ContractFactory.makeFutureContract("NQ", "GLOBEX");
        Commission commission1 = CommissionFactory.getBundledNorthAmericaFutureCommission();
        Instrument instrument1 = new Instrument(contract1, commission1, 20);

        Contract contract2 = ContractFactory.makeStockContract("QQQQ", "SMART");
    ...
    public void setParams() {
        addParam(PERIOD, 5, 1200, 5, 300);
        addParam(ENTRY, 1, 20, 1, 6);
    }
    ...
    public void evaluate() {
        ...
        if (emaDifferential <= -entry) {
            ...
            instrument2.setTargetPosition(-812);
