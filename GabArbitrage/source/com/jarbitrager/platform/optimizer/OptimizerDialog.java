...
import static com.jarbitrager.platform.optimizer.PerformanceMetric.*;
...
public class OptimizerDialog extends JDialog {
    ...
    private void setOptions() throws JArbitragerException {
        ...
        try {
            ...
            if (minTrades < 2) {
                ...
                throw new JArbitragerException("\"" + "Minimum trades" + "\"" + " must be greater or equal to 2.");
            }
        } catch (NumberFormatException nfe) {
            minTradesText.requestFocus();
            throw new JArbitragerException("\"" + "Minimum trades" + "\"" + " must be an integer.");
        }
    }
