...
public abstract class Report {
    ...
    static {
        ...
        REPORT_DIR = JArbitrager.getAppPath() + fileSeparator + "reports" + fileSeparator;
    ...
    protected Report(String reportName) throws JArbitragerException {
        ...
        try {
            ...
            throw new JArbitragerException(ioe);
        }
