package com.jarbitrager.platform.schedule;
...
public class TradingSchedule {
    ...
    public TradingSchedule(String startTime, String endTime, String timeZone) throws JArbitragerException {
    ...
    public void setExclusion(String startExclusionTime, String endExclusionTime) throws JArbitragerException {
    ...
    private int getMinutes(String time) throws JArbitragerException {
